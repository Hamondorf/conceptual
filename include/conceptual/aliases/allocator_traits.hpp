...
using alloc_traits_ ## alias_suffix = typename std::allocator_traits<Alloc>:: aliased_type
...
using alloc_traits_rebind_alloc_t = typename std::allocator_traits<Alloc>::template rebind_alloc<T>;

template <class Alloc, class T>
using alloc_traits_rebind_traits_t = typename std::allocator_traits<Alloc>::template rebind_traits<T>;
